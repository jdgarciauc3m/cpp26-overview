...
\begin{frame}[t,fragile]{C++26: Erroneous behavior}
	\begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Reading an uninitialized variable yields an implementation-defined ("erroneous") value.
      \end{itemize}
\begin{lstlisting}
void f() {
  int count;
  ++count; // Erroneous behavior: reading count yields an implementation-defined value
  std::println("count = {}", count);
}
\end{lstlisting}
